...
import torch
from mmcv.cnn import ConvModule, BiConvModule
...
class BiPointSAModuleMSG(BasePointSAModule):
    ...
    def __init__(self,
        ...
        super(BiPointSAModuleMSG, self).__init__(
            num_point=num_point,
            radii=radii,
...
@SA_MODULES.register_module()
class BiPointSAModule(BiPointSAModuleMSG):
    ...
    def __init__(self,
                 ...
                 normalize_xyz=False,
                 conv_cfg=dict(type='MConv2d')):
        super(BiPointSAModule, self).__init__(
            mlp_channels=[mlp_channels],
            num_point=num_point,
            radii=[radius],
