...
import numpy as np
import torch
from mmcv.cnn import ConvModule, BiConvModule, normal_init
...
class BiPointRCNNBboxHead(BaseModule):
    ...
    def __init__(
            ...
            init_cfg=None):
        super(BiPointRCNNBboxHead, self).__init__(init_cfg=init_cfg)
