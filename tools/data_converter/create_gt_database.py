...
def create_groundtruth_database(dataset_class_name,
    ...
    if database_save_path is None:
        ...
        database_save_path = osp.join("/mnt/lustre/xusheng/Nuscenes", f'{info_prefix}_gt_database')
    if db_info_save_path is None:
        # db_info_save_path = osp.join(data_path,
        #                              f'{info_prefix}_dbinfos_train.pkl')
        db_info_save_path = osp.join("/mnt/lustre/xusheng/Nuscenes",
                                     f'{info_prefix}_dbinfos_train.pkl')
...
class GTDatabaseCreater:
    ...
    def create(self):
        ...
        if self.database_save_path is None:
        # database_save_path = osp.join(data_path, f'{info_prefix}_gt_database')
            self.database_save_path = osp.join("/mnt/lustre/liyanjing/Nuscenes", f'{self.info_prefix}_gt_database')
        if self.db_info_save_path is None:
        # db_info_save_path = osp.join(data_path,
        #                              f'{info_prefix}_dbinfos_train.pkl')
            self.db_info_save_path = osp.join("/mnt/lustre/liyanjing/Nuscenes",
                                        f'{self.info_prefix}_dbinfos_train.pkl')
