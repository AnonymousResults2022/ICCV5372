model = dict(
    ...
    backbone=dict(
        ...
        sa_channels=(((8, 8, 16), (16, 16, 32)), ((32, 32, 64), (32, 48,
                                                                    64)),
                     ((64, 98, 128), (64, 98, 128)), ((128, 128, 256),
                                                          (128, 192, 256))),
    ...
    neck=dict(
        type='PointNetFPNeck',
        fp_channels=((768, 256, 256), (384, 256, 256), (304, 128, 128),
                     (129, 64, 64))),
    rpn_head=dict(
        type='PointRPNHead',
        num_classes=3,
        ...
        pred_layer_cfg=dict(
            in_channels=64,
            cls_linear_channels=(128, 128),
            reg_linear_channels=(128, 128)),
        cls_loss=dict(
            type='FocalLoss',
            use_sigmoid=True,
            reduction='sum',
    ...
    roi_head=dict(
        ...
        point_roi_extractor=dict(
            ...
            roi_layer=dict(type='RoIPointPool3d', num_sampled_points=256)),
        bbox_head=dict(
            ...
            sa_channels=((64, 64, 64), (64, 64, 128), (128, 128, 256)),
